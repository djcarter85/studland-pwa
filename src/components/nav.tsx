...
export default function Nav() {
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 w-full border-t border-gray-200 bg-gray-50/80 backdrop-blur-sm pb-safe dark:border-gray-700 dark:bg-gray-800/80">
